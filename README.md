# PayPack Specifications (paypack-specs)

**Defining the Trust Infrastructure for the AI Agent Economy**

This repository hosts the public specifications, standards, and schemas for the PayPack ecosystem — an open, community-driven effort to build the trust layer for AI agent payments.
...
### 2. Service Metadata Schema (JSON Schema)
- **Status**: Active
